...
namespace Microsoft.AspNetCore.Authentication.OpenIdConnect
{
    ...
    public class OpenIdConnectEvents : RemoteAuthenticationEvents
    {
        ...
        /// </summary>
        public Func<SignedOutRedirectContext, Task> OnSignedOutCallbackRedirect { get; set; } = context => Task.CompletedTask;
        ...
        public virtual Task SignedOutCallbackRedirect(SignedOutRedirectContext context) => OnSignedOutCallbackRedirect(context);
